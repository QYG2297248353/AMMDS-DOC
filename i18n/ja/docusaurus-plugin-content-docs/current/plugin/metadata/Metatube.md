...
title: "Metatube"
description: "MetaTube は Jellyfin、Emby、Plex などのメディアサーバー向けのオープンソースメタデータスクレイピングツールで、高精度な中国語リソース認識をサポートします。"
keywords: [MetaTube, メタデータ, スクレイピング, ポスターウォール, Jellyfin]
