...
description: Learn about the environment variable configurations supported by AMMDS, including port, user permissions, running mode, plugin address, and other parameter descriptions.
