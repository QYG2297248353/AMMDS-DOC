...
description: "The site authentication feature lets the system authenticate with websites, granting access to advanced features like rankings and search after authentication."
